...
namespace dutycore
{
// #define VAL_ASSETS_LOADED (game::ModuleBase + 0x9412942)
#define PTR_WAIT_FOR_SINGLE_OBJECT (game::ModuleBase + 0x1AAE8D14)
#define PTR_GET_XASSET_TYPE_SIZE (game::ModuleBase + 0x13E9DD0)
#define PTR_GET_XASSET_POOL (game::ModuleBase + 0x94093F0)
#define PTR_JMP_XASSET_TYPE_SIZE (game::ModuleBase + 0x332A3E0)
